...
function FullAnalysisApp() {
  ...
  return (
    <div className="app-shell full-analysis-shell">
      <header className="topbar">
        ...
        <div className="run-status-bar">
          <span>workflow {run ? shortId(run.workflowRunId) : "未创建"}</span>
          <span>trace {run ? shortId(run.traceId) : "等待后端返回 trace"}</span>
        </div>
