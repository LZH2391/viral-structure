...
type WorkflowStageStatus = "done" | "running" | "waiting";
...
type WorkflowDetailMetric = {
  label: string;
  value: string;
};

type WorkflowDetailCard = {
  title: string;
  meta: string;
  body: string;
};
...
function resolveWorkflowDetail(stageKey: WorkflowStageKey, item: AnalysisHistoryItem | null, stages: WorkflowStages, structureStatus: WorkflowStageStatus): WorkflowDetail {
