...
function buildAudioFeaturesSummary(result) {
  return {
    ...
    beatFrameCount: result.beatFrames?.length ?? null,
    onsetFrameCount: result.onsetFrames?.length ?? null,
    lowSignal: result.loudnessSummary?.lowSignal ?? null,
    gateReason: result.loudnessSummary?.gateReason ?? null,
