...
const { createConversationArtifactActions } = require("./conversation-store-artifacts");
const {
...
function createAgentConversationStore({ store, filePath } = {}) {
  ...
  const artifactActions = createConversationArtifactActions({ mutateConversation });
  ...
  return {
    ...
    stopThread,
    bindThread,
    bindDefaultMaterialPack: artifactActions.bindDefaultMaterialPack,
    clearDefaultMaterialPack: artifactActions.clearDefaultMaterialPack,
    recordSystemMessage,
    invalidate,
    confirmPlan: artifactActions.confirmPlan,
    createMaterialGapMatrixMessage: artifactActions.createMaterialGapMatrixMessage,
    createStoryboardResultMessage: artifactActions.createStoryboardResultMessage,
    updateStoryboardResultMessage: artifactActions.updateStoryboardResultMessage,
    archive,
    remove,
    assertActive,
  };
