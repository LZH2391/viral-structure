...
function summarizeDebugPayload(value) {
  ...
  return {
    ...
    conversationId: safePreview(value.conversationId, 120),
    conversationThreadId: safePreview(value.conversationThreadId, 120),
    requestThreadId: safePreview(value.requestThreadId, 120),
    expectedThreadId: safePreview(value.expectedThreadId, 120),
    actualThreadId: safePreview(value.actualThreadId, 120),
    turnId: safePreview(value.turnId, 120),
    latestTurnId: safePreview(value.latestTurnId, 120),
