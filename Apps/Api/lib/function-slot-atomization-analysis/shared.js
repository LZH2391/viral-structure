...
function buildOutputContract() {
    ...
    atom_inventory: {
      ...
      rhythm_atoms: [{
        ...
        timing_evidence: {
          ...
          minShotDurationSec: 1.2,
          maxShotDurationSec: 1.2,
          avgShotDurationSec: 1.2,
          medianShotDurationSec: 1.2,
          subtitleCharCount: 6,
          dialogueCharsPerSec: 5,
          derivedPace: "fast",
          shotTimings: [{
            shotRef: "shot_1",
            start: 0,
  ...
  return {
    ...
    field_roles: {
      ...
      SourceTrace: ["*.source_refs", "atom_inventory.rhythm_atoms[].timing_evidence"],
      "Meta.StructuralMeta": [
        "*.id",
