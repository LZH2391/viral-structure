...
const { bindCompletedMaterialRecognitionItem, handleAnalysis, handleAnalysisRoles, handleArtifact, handleCapabilities, handleJob, handleJobCacheDecision, handleLegacyAnalysis, handleModules, handlePackagingStructure, handleRhythmStructure, handleScriptSegments, handleShotBoundary, handleSubtitleRevision, handleUpload } = require("./lib/http/server-route-handlers");
