...
from .turn_activity_summary import AppServerTurnActivitySummaryMixin
from .transport_base import TransportEvent



class AppServerTurnResultMixin(AppServerTurnActivitySummaryMixin):
    ...
    def inspect_turn_activity(self, thread_id: str, turn_id: str) -> TurnActivitySnapshot:
        ...
        for turn in thread.get("turns", []):
            ...
            return TurnActivitySnapshot(
                ...
                latest_item_type=latest.get("kind"),
                latest_message_preview=latest.get("preview"),
