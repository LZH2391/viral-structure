...
test("pixi graph colors are sourced from css graph tokens", () => {
  ...
  assert.match(graphCss, /--slot-graph-node-muted-alpha: 0\.5/);
  assert.match(graphCss, /--slot-graph-node-focus-muted-alpha: 0\.26/);
  ...
  assert.match(graphVisualStyles, /nodeMutedAlpha: 0\.5/);
  assert.match(graphVisualStyles, /nodeFocusMutedAlpha: 0\.26/);
