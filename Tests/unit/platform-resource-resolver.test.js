...
test("resource resolver does not own projection resources", async () => {
  const resolver = createResourceResolver();

  assert.equal(await resolver.read({ resourceKind: "projection", resourceId: "analysis-history" }), null);
});
